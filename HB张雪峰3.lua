...
local Tabs = {
  ...
  dao = Window:Tab({ Title = "🗡️刀刃球🗡️", Icon = "dao" }),
    shen99 = Window:Tab({ Title = "shen99", Icon = "99" }),
...
--shen99
local shen99Section = Tabs.shen99:Section({ Title = "shen99" })
...
shen99Section:Button({
  Title = "99",
  Callback = function()loadstring(game:HttpGet("https://rblxscripts.net/raw/99-nights-in-the-forest-foxname-bring-items-god-mode-auto-gr-f4e6400e"))()

  end
})
shen99Section:Button({
  Title = "99",
  Callback = function()loadstring(game:HttpGet("https://raw.githubusercontent.com/Iceware-RBLX/Roblox/refs/heads/main/loader.lua",true))()

  end
})
shen99Section:Button({
  Title = "99",
  Callback = function()loadstring(game:HttpGet("https://raw.githubusercontent.com/Kenniel123/99-Nights-in-the-Forest/refs/heads/main/99%20Nights%20in%20the%20Forest"))()
